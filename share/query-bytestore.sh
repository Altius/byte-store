...
\
    query-bytestore.sh [ --whole-genome | --mutual-regions | --diagonal-walk <int> ] \
                       [ --xfac2015                                            | \
                         ...
                         --hg38-229sample-5mer-pearsonr-masterlist             | \
...
while (1)
    ...
    case --hg38-dnaseI:
        ...
        breaksw;
    case -k:
    case --hg38-5mer-pearson:
        set db = "hg38-5mer-pearson"
        @ db_cnt += 1
        shift;
        breaksw;
    case -2:
    case --hg38-229sample-dnaseI-pearsonr-WM20170911:
        ...
        shift;
        breaksw;
    case --hg38-229sample-dnaseI-pearsonr-masterlist:
        set db = "hg38-229sample-dnaseI-pearsonr-masterlist"
        @ db_cnt += 1
        shift;
        breaksw;
    case --hg38-229sample-presenceabsence-jaccard-masterlist:
        ...
        shift;
        breaksw;
    case --hg38-229sample-5mer-pearsonr-masterlist:
        set db = "hg38-229sample-5mer-pearsonr-masterlist"
        @ db_cnt += 1
        shift;
        breaksw;
    ...
    case --hg38-3clip-euclidean:
        ...
        shift;
        breaksw;
    case --hg38-644sample-dnaseI-pearsonr-masterlist:
        set db = "hg38-644sample-dnaseI-pearsonr-masterlist"
        @ db_cnt += 1
        shift;
        breaksw;
    case --hg38-644sample-dnaseI-pearsonr-masterlist-1M-subset:
        set db = "hg38-644sample-dnaseI-pearsonr-masterlist-1M-subset"
        @ db_cnt += 1
        shift;
        breaksw;
    case --hg38-644sample-5mer-pearsonr-masterlist:
        ...
        shift;
        breaksw;
    case --hg38-16component-NMF-pearsonr:
        set db = "hg38-16component-NMF-pearsonr"
        @ db_cnt += 1
        shift;
        breaksw;
    case --mm10-198sample-dnaseI-pearsonr-092017:
        set db = "mm10-198sample-dnaseI-pearsonr-092017";
        @ db_cnt += 1
        shift;
        breaksw;
    case --mm10-198sample-dnaseI-pearsonr-092417:
        set db = "mm10-198sample-dnaseI-pearsonr-092417";
        @ db_cnt += 1
        shift;
        breaksw;
    case -M:
...
if ( $db == "xfac2015" ) then
...
else if ( $db == "hg38-5mer-pearson" ) then
    ...
    set db_type = "pearson-r-sqr-split"
else if ( $db == "hg38-229sample-dnaseI-pearsonr-masterlist" ) then
    ...
    set db_type = "jaccard-index-sqr-split"
else if ( $db == "hg38-229sample-5mer-pearsonr-masterlist" ) then
    ...
    set db_type = "pearson-r-sqr-split"
else if ( $db == "hg38-229sample-3clip-pearsonr-masterlist" ) then
    ...
    set db_type = "pearson-r-sqr-split"
else if ( $db == "mm10-198sample-dnaseI-pearsonr-092017" ) then
    set master = "/net/seq/data/projects/bytestore/198_mouse_master_list_v091917a/normalized_dnaseI_density/pearson_r/prerequisites/results/master_with_row_indices.bed"
    set store = "/net/seq/data/projects/bytestore/198_mouse_master_list_v091917a/normalized_dnaseI_density/pearson_r/production/results/198_mouse_master_list_v091917a.normalized_dnaseI_density.25000r.bs"
    set db_type = "pearson-r-sqr-split"
else if ( $db == "mm10-198sample-dnaseI-pearsonr-092417" ) then
    set master = "/net/seq/data/projects/bytestore/198_mouse_master_list_v092417a/normalized_dnaseI_density/pearson_r/prerequisites/results/master_with_row_indices.bed"
    set store = "/net/seq/data/projects/bytestore/198_mouse_master_list_v092417a/normalized_dnaseI_density/pearson_r/production/results/198_mouse_master_list_v092417a.normalized_dnaseI_density.25000r.bs"
    set db_type = "pearson-r-sqr-split"
